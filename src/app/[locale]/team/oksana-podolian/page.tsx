...
const DESCRIPTION =
  'Оксана Подолян — адвокат, асоційована партнерка АО «Ганган і Партнери». Захист клієнтів у кримінальних справах, пов’язаних із легалізацією доходів, ухиленням від сплати податків та службовими злочинами, а також підготовка заяв до ЄСПЛ.';
        ...
        <div>
          <section className="mb-10">
            ...
            <p className="text-justify text-[14px] leading-[1.85] text-[var(--ink2)]">
              Окремий напрям практики — підготовка та подання заяв до Європейського суду з прав
              людини (ЄСПЛ) у справах, де вичерпано національні засоби юридичного захисту.
            </p>
          </section>
